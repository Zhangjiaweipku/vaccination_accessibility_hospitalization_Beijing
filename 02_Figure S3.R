...
merged_data <- all_data %>%
  ...
  mutate(total_visits_1516_103 = ifelse(is.na(total_visits_1516_103), 0, total_visits_1516_103))  
...
data_standardized <- merged_data %>%
  mutate(
    ...
    total_visits_1617_std = scale(total_visits_1617_103), 
    total_visits_1718_std = scale(total_visits_1718_103),  
...
reg_results_std <- reg_results_std %>%
  ...
  mutate(term = case_when(
    ...
    term %in% c("total_visits_1516_std", "total_visits_1617_std", "total_visits_1718_std") ~ "ARI-related hospitalisations last season"
  ))
...
ggsave("Figure S3.png",  width = 20, height = 16, dpi = 300, bg = "white")  
